(function () {
  'use strict';
  const { GRADES, GRADE_LABELS, loadCucumberData, saveCustomer, savePrices, saveSale, cancelSale } = window.CucumberSales;
