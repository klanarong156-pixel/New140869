const CACHE_NAME = 'smartfarm-v7.4-ota-dashboard-clarity-1';
const APP_SHELL = [
  './', './index.html', './404.html', './auth.html', './schedule.html', './finance.html', './cucumber-sales.html', './account.html', './settings.html', './admin.html', './ota.html', './ota-standalone.html',
  './manifest.json', './app.css', './readability-overhaul.css', './app.js', './dashboard-admin-tools.js', './dashboard-ota.js', './config.js', './mqtt-handler.js', './internet-time.js', './weather.js', './auto-weather-guard.js', './schedule.js', './firebase.js', './access.js', './auth-page.js', './finance-core.js', './finance-firebase.js', './finance.js', './account.js', './admin.js', './crop-reminders.js', './crop-plots.js', './farm-analytics.js', './ai-farm-advisor.js', './farm-tools.js', './farm-clock.js', './mqtt-shared-worker.js', './user-management.js', './MQTT_CONTRACT_V6.html', './HARDWARE_V6.html',
  './logo.png', './assets/logo-suanlungna-transparent.png', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './cucumber-sales.css', './cucumber-sales-dashboard.css', './dashboard-overhaul.css', './cucumber-sales.js', './cucumber-sales-firebase.js', './cucumber-sales-dashboard.js'
];
