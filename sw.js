const CACHE_NAME = 'smartfarm-v9.0-new-dashboard-1';
const APP_SHELL = ['./connection.html','./dashboard-connection.css','./dashboard-new.css','./dashboard-new.js','./mqtt.min.js',
