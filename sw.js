...
const APP_SHELL = [
  ...
  './logo.png', './assets/logo-suanlungna-transparent.png', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './cucumber-sales.css', './cucumber-sales-dashboard.css', './cucumber-sales.js', './cucumber-sales-firebase.js', './cucumber-sales-dashboard.js'
];
