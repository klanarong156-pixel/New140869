const CACHE_NAME = 'smartfarm-v10-clean-dashboard-1';
const APP_SHELL = [
  './', './index.html', './dashboard/', './dashboard/index.html',
  './dashboard/dashboard.css?v=1', './dashboard/dashboard-config.js?v=1',
  './dashboard/dashboard-state.js?v=1', './dashboard/dashboard-mqtt.js?v=1',
  './dashboard/dashboard.js?v=1', './mqtt.min.js?v=5', './404.html',
  './connection.html', './dashboard-connection.css',
