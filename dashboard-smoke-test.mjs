...
const checks = [
  ...
  ['Emergency command safety logic remains available outside Dashboard UI', /function emergencyStop/.test(read('farm-tools.js')) && /function resetEmergencyStop/.test(read('farm-tools.js')) && /EMERGENCY_STOP/.test(read('farm-tools.js')) && /EMERGENCY_RESET/.test(read('farm-tools.js'))],
  ...
  ['Emergency stop uses existing relay OFF commands', /relaySet\(relay\), 'OFF'/.test(tools)],
