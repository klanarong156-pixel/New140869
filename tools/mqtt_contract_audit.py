...
checks = {
    ...
    'relay countdown removed': not any(token in firmware + app + config + handler for token in ('MAX_TIMER_SECONDS', 'parseTimerSeconds', 'UNLIMITED', 'relayTimer', 'timer/set', 'timer/status')),
