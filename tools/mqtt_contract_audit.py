...
connection = (root / 'connection.html').read_text()
...
checks = {
    ...
    'credentials input': 'data-mqtt-user' in connection and 'data-mqtt-pass' in connection and 'setCredentials(user,pass)' in connection,
    ...
    'no fake soil sensor': 'soil' not in connection.lower() or 'not installed' in connection.lower(),
