...
| GPIO สำรอง | D3 | GPIO0 | ไม่ได้ใช้งานโดย firmware | เป็น bootstrap pin; ปล่อยตามข้อกำหนดการบูตของ ESP8266 |
| GPIO สำรอง | D4 | GPIO2 | ไม่ได้ใช้งานโดย firmware | เป็น bootstrap pin; ปล่อยตามข้อกำหนดการบูตของ ESP8266 |
...
5. ถ้า Wi‑Fi หลุดหลัง NTP sync แล้ว ตารางจะใช้เวลาที่ sync ล่าสุดต่อด้วย `millis()`; หลัง reboot ระบบจะไม่เปิดปั้มตามตารางจนกว่าจะ sync NTP สำเร็จ
...
| sync NTP | 6 ชั่วโมง และ sync ใหม่ทันทีเมื่อ Wi‑Fi กลับมา |
